...
client_1.takeoffAsync(vehicle_name="Drone1")
...
print("sending drone to birds view of world")
client_1.moveToPositionAsync(0, 0, -300, 30, vehicle_name="Drone1").join()
# airsim.wait_key('Press any key to take images')
# get camera images from the car
responses1 = client_1.simGetImages([
    airsim.ImageRequest("bottom_center", airsim.ImageType.DepthVis),  #depth visualization image
    airsim.ImageRequest("bottom_center", airsim.ImageType.Scene, False, True)], vehicle_name="Drone1")  #scene vision image in uncompressed RGBA array
...
tmp_dir = os.path.join(os.getcwd(), "world_maps_temp")
